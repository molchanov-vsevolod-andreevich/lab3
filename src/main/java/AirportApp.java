...
public class AirportApp {
    public static void main(String[] args) {
        ...
        JavaRDD<String> splittedAirportsRDD = airportsRDD.flatMap(s -> Arrays.stream(s.substring(s.indexOf(System.getProperty("line.separator")))+1).replace("\"", "").replace(",", ";").split("\n")).iterator());
